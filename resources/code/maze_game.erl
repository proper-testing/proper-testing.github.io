...
-export([level/1, build_level/1]).
-export([prop_exit_unreachable/1, prop_targeted_exit_unreachable/1]).
%% -export([run_random/1, run_random2/1, run_targeted/1, run_targeted2/1]).
...
%% Levels
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
-spec level(non_neg_integer()) -> level_data().
level(0) ->
  ["#########",
   "#X     E#",
   "#########"];
